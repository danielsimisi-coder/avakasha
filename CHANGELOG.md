...
- Fix: choosing a location (WhatsApp, Downloads, any folder) after the overview or Free up space showed an empty screen: the scan ran and counted the files, but the file list, its filters and its actions stayed hidden. Leaving either screen now brings them back, and the smoke test checks both paths.
