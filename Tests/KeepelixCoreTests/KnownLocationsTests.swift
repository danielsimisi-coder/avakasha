...
final class KnownLocationsTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        home = FileManager.default.temporaryDirectory.appendingPathComponent("keepelix-home-" + UUID().uuidString, isDirectory: true)
    ...
    func testPresentListsOnlyExistingRealDirectories() throws {
        ...
        try Data("not a folder".utf8).write(to: home.appendingPathComponent(".gradle", isDirectory: true).path.isEmpty ? home : home.appendingPathComponent("go"))
